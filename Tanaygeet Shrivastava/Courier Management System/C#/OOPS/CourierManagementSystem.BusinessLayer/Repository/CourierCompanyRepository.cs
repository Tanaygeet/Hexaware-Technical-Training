...
namespace CourierManagementSystem.BusinessLayer.Repository
{
    public class CourierCompanyRepository : ICourierCompanyRepository
    {
        ...
        public CourierCompanyRepository(string companyName, List<Courier> courierDetails, List<Employee> employeeDetails, List<Location> locationDetails)
        {
            ...
            couriercompany.Employee = employeeDetails;
        ...
        {
            return $"CourierCompany {{ companyName={couriercompany.CompanyName}, courierDetails='{couriercompany.CourierDetails}', employeeDetails='{couriercompany.Employee}', " +
        ...
        {
            Console.WriteLine($"{couriercompany.CompanyName}, {couriercompany.CourierDetails},{couriercompany.Employee},{couriercompany.LocationDetails}");
        }
    }
}
